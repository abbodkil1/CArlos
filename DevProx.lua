...
DevId = sudos.SUDO 
sudo_users = {sudos.sudo_users,218385683,1330377150} 
bot_id = sudos.bot_id 
...
if is_leader(msg) then 
local Sudo_Welcome = '⌁︙اهلا بك مجددا عزيزي المطور \n⌁︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس فكتور فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == 'سورس كارلوس' or text == 'سورس بروكس' or text == 'سورس فكتور' or text == 'سورس زربه' or text == 'السورس زربه' or text == 'سورس عاوي' or text == 'السورس عاوي' then if not DevAbs:get(DevProx..'bot:rep:mute'..msg.chat_id_) then ABS_PROX =  "لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪" else ABS_PROX = '' end Dev_Abs(msg.chat_id_, msg.id_, 1, ABS_PROX, 1, 'md') end 
end
--     Source DevProx     --
...
⌁︙نقاطي • بيع نقاطي
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Source Channel](https://t.me/So_Victor)
]], 1, 'md')
end
end
--     Source DevProx     --
...
if tonumber(result.sender_user_id_) == tonumber(1330377150) then
t = 'مبرمج السورس'
...
return false  end
if res.id_ then  
if tonumber(res.id_) == tonumber(1330377150) then
t = 'مبرمج السورس'
...
if tonumber(iduser) == tonumber(1330377150) then
t = 'مبرمج السورس'
...
local list = DevAbs:smembers(DevProx.."bot:groups")
local text = "(Source DevProx - سورس فكتور)\nΞ - File bot groups -\nΞ - ملف مجموعات البوت -\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(list) do
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙جاري تحديث سورس فكتور', 1, 'md') 
os.execute('rm -rf DevProx.lua') 
os.execute('wget https://github.com/abbodkil1/CArlos.git/master/DevProx.lua') 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ @So_Victor', 1, 'html')    
end 
--     Source DevProx     --
if is_leader(msg) then 
